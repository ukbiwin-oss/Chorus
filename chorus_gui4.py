...
class ChorusApp:
    ...
    def _build_ui(self):
        ...
        subtitle = ttk.Label(
            outer,
            text="Ask a question. The local models debate it, challenge each other, and produce a final answer.",
        )
        ...
        prompt_label = ttk.Label(prompt_pane, text="Your question", font=("TkDefaultFont", 11, "bold"))
        ...
        self.copy_btn.grid(row=0, column=4, padx=(0, 8))
    ...
    def _setup_tags(self):
        ...
        self.output.tag_configure("round", foreground="#5a2ca0", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("final", foreground="#0b6e4f", font=("TkDefaultFont", 13, "bold"))
        self.output.tag_configure("section", foreground="#4a4a4a", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("speaker_creative", foreground="#9c27b0", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("speaker_practical", foreground="#1565c0", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("speaker_systems", foreground="#00897b", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("speaker_critic", foreground="#c62828", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("speaker_default", foreground="#333333", font=("TkDefaultFont", 12, "bold"))
        self.output.tag_configure("body", foreground="#111111", font=("TkDefaultFont", 12))
        self.output.tag_configure("dead", foreground="#a00000", font=("TkDefaultFont", 11, "bold"))
        self.output.tag_configure("problem", foreground="#444444", font=("TkDefaultFont", 12, "bold"))
    ...
    def run_chorus(self):
        ...
        self.clear_output()
        self.status_var.set("Running the debate...")
